...
use WilsonGlasser\Spout\Writer\Common\Creator\Style\BorderBuilder;
...
use box\spout;
use yii\queue\Queue;
use specialist\excelreport\ExcelReportHelper;
...
class ExcelReportModel
{
    ...
    public function initExcelWriter($config)
    {
        ...
        $this->_objWriter = WriterEntityFactory::createWriter($config['writer']);
    ...
    public function initExcelWorksheet()
    {
        ...
        $this->_objWorksheet->setName(Yii::t('specialist', 'Report'));
    }
