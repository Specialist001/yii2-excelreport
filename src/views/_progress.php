...
<div id="save-file" style="display: none;">
    <?= Yii::t('specialist','Saving file') ?>
</div>


<div id="progress-file" style="display: none;">
    <a href="/excelreport/report/download" target="_blank"><?= Yii::t('specialist','Download last report') ?></a>
</div>
<div id="reset-progress">
    <a id="reset-progress-link" href="#"><?= Yii::t('specialist','Stop generation') ?></a>
</div>
